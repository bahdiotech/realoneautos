...
import { Car, Mail, Lock, Phone, User } from "lucide-react"
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="ml-3 text-2xl font-bold text-gray-900">REALONE AUTO</span>
          </div>
          <p className="text-gray-600">Mobile Mechanics At Your Door</p>
        </div>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <CardHeader>
                ...
                <CardDescription>
                  Sign in to your account to manage your vehicles and appointments
                </CardDescription>
              </CardHeader>
